...
function ciniki_reseller_settingsHistory($ciniki) {
    ...
    $rc = ciniki_reseller_checkAccess($ciniki, $args['business_id'], 'ciniki.reseller.settingsHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.reseller', 'ciniki_reseller_history', 
        $args['business_id'], 'ciniki_reseller_settings', $args['setting'], 'detail_value');
}
?>
